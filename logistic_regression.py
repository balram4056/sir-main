...
cv_scores = cross_val_score(lr_model, X_train_vectors, y_train, cv=10, scoring='f1')
...
plt.title('10-Fold Cross-Validation F1 Scores for Logistic Regression')
plt.xlabel('Fold')
plt.ylabel('F1 Score')
plt.ylim(0, 1)
plt.grid(True)
...
execution_time = timeit.timeit(example_code, number=1)  # Number of times to execute
